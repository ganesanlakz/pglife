    ...
    <body>
        <div class="header sticky-top">
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="my-navbar">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="signup.html" data-toggle="modal" data-target="#signup-modal">
                                <i class="fas fa-user"></i>Signup
                            </a>
                        </li>
                        <div class="nav-vl"></div>
                        <li class="nav-item">
                            <a class="nav-link" href="login.html" data-toggle="modal" data-target="#login-modal">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb py-2">
                ...
                <li class="breadcrumb-item">
                    <a href="mproperty_list.html">Mumbai</a>
                </li>
        ...
        <div id="property-images" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
                ...
                <li data-target="#property-images" data-slide-to="1" class="active"></li>
        ...
        <div   class="name" style="margin-top: 120px;">
            <div class="con">PG IN MUMBAI</div>
            <div class="con">PG IN HYDERABAD</div>
            <div class="con">PG IN DELHI</div>
            <div class="con">PG IN CHENNAI</div>
          </div> 
          <div class="col-md-12" id="copyright"><p id="copy">A@ 20xx copy right pglife</p></div>     
