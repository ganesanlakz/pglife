...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2022 at 02:14 PM
...
--
-- Table structure for table `intrested_user_properties`
--

CREATE TABLE `intrested_user_properties` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `intrested_user_properties`
--

INSERT INTO `intrested_user_properties` (`id`, `user_id`, `property_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 5),
(4, 2, 1),
...
(1, 1, 'Saxena\'s Paying Guest', 'H.No. 3958 Kaseru Walan, Pahar Ganj, New Delhi, Delhi 110055', 'Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - ', 'male', 5000, 4, 3, 5),
(2, 1, 'Navrang PG Home', '644-C,Mohalla Baoli 6 Tooti Chowk, Paharganj, New Delhi, Delhi 110055', 'Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - ', 'unisex', 6000, 3, 3, 4),
(3, 2, 'Navkar Paying Guest', '44, Juhu Scheme, Juhu, Mumbai, Maharashtra 400058', 'Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - ', 'female', 9500, 4, 4, 5),
(4, 2, 'PG for Girls Borivali West', 'Plot no.258/D4, Gorai no.2, Borivali West, Mumbai, Maharashtra 400092', 'Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - ', 'female', 8000, 4, 4, 5),
(5, 2, 'Ganpati Paying Guest', 'Police Beat, Sainath Complex, Besides, SV Rd, Daulat Nagar, Borivali East, Mumbai - 400066', 'Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - ', 'male', 8500, 4, 4, 5);
...
--
-- Indexes for table `intrested_user_properties`
--
ALTER TABLE `intrested_user_properties`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `intrested_user_properties`
--
ALTER TABLE `intrested_user_properties`
...
--
-- Constraints for table `intrested_user_properties`
--
ALTER TABLE `intrested_user_properties`
  ADD CONSTRAINT `intrested_user_properties_ibfk_1` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`),
  ADD CONSTRAINT `intrested_user_properties_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
